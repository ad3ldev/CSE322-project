...
const SignUpDoctor = () => {
  ...
  const createDoctor = (e) => {
    ...
    if (doctor.email === "" || doctor.password === "" || doctor.name === "") {
      showAlert();
    ...
    <div className="Dcontainer">
      <form className="contact__form">
        ...
        <div className="Demail">
          ...
          <small className="email__alert">Please enter a valid address</small>
        </div>
        ...
        <div className="Demail">
          ...
          <small className="password__alert">
            6 to 20 characters and contain one number and one uppercase letter
          </small>
        </div>
        ...
        <div className="Dage">
          ...
          <small className="email__alert">Age can't be empty or negative</small>
        </div>
